class ProfilesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @profile.save
        format.html { redirect_to @profile, notice: 'Tu perfil se ha actualizado con exito' }
  ...
  def update
    respond_to do |format|
      if @profile.update(profile_params)
        format.html { redirect_to current_user.profile, notice: 'Tu perfil se ha actualizado con exito' }
  ...
  private
    ...
    def profile_params
      params.require(:profile).permit(:name, :phone, :age, :address)
    end
end